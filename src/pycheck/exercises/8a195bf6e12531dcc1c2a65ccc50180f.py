...
**a)** Si el lobo está cerca de una oveja, habrá que responder con el mensaje: _"Cuidado oveja X, el lobo te va a comer"_.  
**b)** Si el lobo está al final de la lista, habrá que responder con el mensaje: _"No te quiero ver más por aquí, lobo"_
