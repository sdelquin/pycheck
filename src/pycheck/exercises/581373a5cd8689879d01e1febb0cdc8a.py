...
- Trabaje siempre con **valores flotantes** y obtenga la salida con **3 cifras decimales**.
"""
...
CHECK_CASES = [
    [['data/sum_crypto/data1.crypto'], [-533.728]],
    [['data/sum_crypto/data2.crypto'], [5689.511]],
    [['data/sum_crypto/data3.crypto'], [-7587.066]],
]
